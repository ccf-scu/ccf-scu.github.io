...
- 生产分支：`main`，承载 Astro + Decap CMS 静态站，由 Cloudflare Pages 自动构建并发布到 `https://www.ccfscu.com`。
...
6. 旧站以 commit `b904313` 和标签 `pre-astro-launch-2026-08-22` 保持可恢复；非 `main` 分支不得部署到正式 Cloudflare Pages 域名。
