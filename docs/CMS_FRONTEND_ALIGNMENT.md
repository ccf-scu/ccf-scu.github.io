...
| 指导老师 | 关于分会 | 仅展示“显示”开启的老师，按“显示顺序”数字升序；CMS 列表拖动已关闭 |
| 关于分会：相关链接 | 关于分会 | 所有开启“显示”的项目按“显示顺序”数字升序；不再要求选择链接类型或用途，CMS 列表拖动已关闭 |
| 首页：开源按钮 | 首页开源区 | 独立设置按钮文字、仓库地址和显隐 |
| 全站：页脚链接 | 全站页脚 | 独立列表，按“显示顺序”数字升序展示可见项目，不再混入关于页相关链接 |
| 联系方式（含 QQ 群） | 关于分会、全站页脚 | 可在后台直接修改显示值、链接、显示顺序和显隐；数字越小越靠前 |
